...
export type Query = {
  __typename?: 'Query';
  messages?: Maybe<Array<Maybe<Chat>>>;
};

export type Subscription = {
  __typename?: 'Subscription';
  onMessageCreated?: Maybe<Chat>;
};
...
export type ChatResolvers<ContextType = any, ParentType = ResolversParentTypes['Chat']> = {
...
export type MutationResolvers<ContextType = any, ParentType = ResolversParentTypes['Mutation']> = {
  createMessage?: Resolver<Maybe<ResolversTypes['Chat']>, ParentType, ContextType, RequireFields<MutationCreateMessageArgs, 'message' | 'receiverId' | 'senderId'>>;
};

export type QueryResolvers<ContextType = any, ParentType = ResolversParentTypes['Query']> = {
  messages?: Resolver<Maybe<Array<Maybe<ResolversTypes['Chat']>>>, ParentType, ContextType>;
};

export type SubscriptionResolvers<ContextType = any, ParentType = ResolversParentTypes['Subscription']> = {
  onMessageCreated?: SubscriptionResolver<Maybe<ResolversTypes['Chat']>, "onMessageCreated", ParentType, ContextType, RequireFields<SubscriptionOnMessageCreatedArgs, 'subscriberId'>>;
};
